...
#define AI_NETWORK_1_ORIGIN_MODEL_NAME   "clean_perchannel_quant_v7_calib_input_only_npz_1"
...
#define AI_NETWORK_1_IN_1_HEIGHT      (1)
#define AI_NETWORK_1_IN_1_WIDTH       (960)
#define AI_NETWORK_1_IN_1_CHANNEL     (1)
#define AI_NETWORK_1_IN_1_SIZE        (960)
#define AI_NETWORK_1_IN_1_SIZE_BYTES  (960)

/******************************************************************************/
#define AI_NETWORK_1_OUT_NUM       (2)
...
#define AI_NETWORK_1_OUT_SIZE { \
  ...
  AI_NETWORK_1_OUT_2_SIZE, \
}
#define AI_NETWORK_1_OUT_SIZE_BYTES { \
  AI_NETWORK_1_OUT_1_SIZE_BYTES, \
  AI_NETWORK_1_OUT_2_SIZE_BYTES, \
}
#define AI_NETWORK_1_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_NETWORK_1_OUT_1_HEIGHT      (1)
#define AI_NETWORK_1_OUT_1_WIDTH       (320)
#define AI_NETWORK_1_OUT_1_CHANNEL     (1)
#define AI_NETWORK_1_OUT_1_SIZE        (320)
#define AI_NETWORK_1_OUT_1_SIZE_BYTES  (320)
#define AI_NETWORK_1_OUT_2_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_NETWORK_1_OUT_2_HEIGHT      (1)
#define AI_NETWORK_1_OUT_2_WIDTH       (320)
#define AI_NETWORK_1_OUT_2_CHANNEL     (1)
#define AI_NETWORK_1_OUT_2_SIZE        (320)
#define AI_NETWORK_1_OUT_2_SIZE_BYTES  (320)

/******************************************************************************/
#define AI_NETWORK_1_N_NODES (52)
