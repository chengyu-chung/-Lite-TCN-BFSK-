...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "v6_nano_l476_1200_pure_static_perchannel_quant_dataset_eval_npz_1"
...
#define AI_NETWORK_IN_1_WIDTH       (1200)
